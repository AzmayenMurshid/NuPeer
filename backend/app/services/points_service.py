...
def award_points(
    ...
    # Ensure point_type is a PointType enum instance (TypeDecorator handles conversion to string)
    ...
    # TypeDecorator will automatically convert enum to string value for database storage
